...
studies from a known hierarchical model. We simulate 30 studies from a
...
baseline imbalance). The fractional scale is what
[`meta_did()`](https://ben18785.github.io/metadid/reference/meta_did.md)
reports by default; see
...
![](reference/figures/README-comparison.png)
