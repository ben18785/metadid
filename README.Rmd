...
`meta_did()` fits a hierarchical Bayesian model. Setting `method = "optimize"` finds the maximum a posteriori (MAP) estimate via L-BFGS — this is faster than MCMC but provides no uncertainty measures in estimates.
