...
metadid supports this through the `multiplicative_covariate` argument. The indicator has a single binary level $m_i \in \{0, 1\}$, with a single estimated `multiplier` applied to the studies where it equals 1:
