...
The true population treatment effect is -0.15 on the raw scale. With baseline normalisation (the default — effects expressed as fractions of the treatment-arm pre-treatment baseline), this corresponds to approximately -0.333 on the normalised scale.
