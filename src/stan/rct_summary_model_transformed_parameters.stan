...
vector[n_studies_rct_summary] baseline_difference_rct_summary;
...
for (i in 1:size(baseline_difference_rct_summary_raw))
  baseline_difference_rct_summary[i] = gamma_from_raw(
    gamma_mode_rct_summary[i], baseline_difference_rct_summary_raw[i],
    baseline_difference_mean, baseline_difference_sd,
    kappa, gamma_scale_rct_summary[i]);
